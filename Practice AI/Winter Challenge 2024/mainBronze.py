...
################
def sucheZug(feldDict,runde,i,required_actions_count,myProtList,oppProtList,moveList,ergDict,sporeZiel):
    ...
    if abstand == 2 and feldDict[zielProt].typ == "A" and myProtList[2] > 0 and myProtList[3] > 0:
...
####
    ...
    ergDict[runde] = copy.deepcopy(tList)
    return actionList

#######
#######
#######
feldDict={};moveList=[];ergDict={};sporeZiel=[]
