...
ANZAHLTROLLE=5;RUNDETROLL=200;MAXTROLLWERT=3;OPPCHOP=False;AROUNDBASE=5
...
def setTreeDistanz(treeDict,xyPos,moveZiel,zielDict,minWert,scoreList,naechsterTroll,chopen):    
    distanzDict={}
...
def bewegung(width,height,runde,myBase,oppBase,lineList,scoreDict,treeDict,trollDict,ergList,grundList,moveList,graph,ironList,waterList,baseDict,zielDict,baseAround):
    ...
    for trollId,troll in trollDict.items():
        ...
        ## pauschale Auswahl: Harvest, Chop und Move                             
                ...
                troll.treeDict=setTreeDistanz(treeDict,troll.xy,moveZiel,zielDict,len(trollList)+1,scoreList,naechsterTroll,trollId in chopList)
