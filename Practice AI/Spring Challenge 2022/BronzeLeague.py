...
def sucheZiel(m,my_heroes,monsters,opp_heroes,myHealth,myMana,emHealth,emMana,base_x,base_y,emBase_x,emBase_y):
    if base_x == 0:
...
# game loop
while True:
    myHealth=0;myMana=0;emHealth=0;emMana=0
    for i in range(2):
    ...
    for i in range(heroes_per_player):
        target = None        
        befehl,x,y,idZiel = sucheZiel(i,my_heroes,monsters,opp_heroes,myHealth,myMana,emHealth,emMana,base_x,base_y,emBase_x,emBase_y)        
