...
def check(y,x,n,outList,abcList,abcDict,cagesDict):
    for i in range(9):
...
def zero(outList,abcList,abcDict,cagesDict):
    for i in range(9):
        for j in range(9):
            if outList[i][j]==0:
                return i,j
...
def solve(outList,abcList,abcDict,cagesDict):
    z = zero(outList,abcList,abcDict,cagesDict)
    #print("solve")
    if z == None:
        return True
    y,x=z
    for i in range(1,10):
        if check(y,x,i,outList,abcList,abcDict,cagesDict):
            outList[y][x]=i
            if solve(outList,abcList,abcDict,cagesDict):
                return True
            outList[y][x]=0
    return False
...
solve(outList,abcList,abcDict,cagesDict)
